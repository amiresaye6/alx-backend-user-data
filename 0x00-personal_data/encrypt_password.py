...
def hash_password(password: str) -> bytes:
    ...
    Args:
        password (str): A string containing the plain text password to be
        hashed.
...
def is_valid(hashed_password: bytes, password: str) -> bool:
    ...
    Args:
        hashed_password (bytes): A byte string representing the salted, hashed
        password.
        password (str): A string containing the plain text password to be
        validated.
    ...
    """
    encoded = password.encode()
    valid = bcrypt.checkpw(encoded, hashed_password)
